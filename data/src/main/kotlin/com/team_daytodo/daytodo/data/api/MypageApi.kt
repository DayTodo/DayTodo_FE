...
import com.team_daytodo.daytodo.data.dto.mypage.NotificationSettingsResponse
...
interface MypageApi {
    ...
    suspend fun deleteFcmToken(@Body request: DeleteFcmTokenRequest): Response<Unit>
